        ...
        <div className='bg-black min-h-screen text-white'>
            ...
            <div className='container mx-auto px-4 py-8'>
                <div className='flex justify-center gap-3 mb-4'>
                    <button
                        className={`py-2 px-4 rounded ${activeTab === "movie" ? "bg-blue-600" : "bg-gray-800"
                            } hover:bg-blue-700`}
                    ...
                    <button
                        className={`py-2 px-4 rounded ${activeTab === "tv" ? "bg-blue-600" : "bg-gray-800"
                            } hover:bg-blue-700`}
                    ...
                    <button
                        className={`py-2 px-4 rounded ${activeTab === "person" ? "bg-blue-600" : "bg-gray-800"
                            } hover:bg-blue-700`}
